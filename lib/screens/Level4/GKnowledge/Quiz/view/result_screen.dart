...
class ResultScreen17 extends StatefulWidget {
  const ResultScreen17({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen17> createState() => _ResultScreen17State();
}

class _ResultScreen17State extends State<ResultScreen17> {
