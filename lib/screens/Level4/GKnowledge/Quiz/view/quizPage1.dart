...
class QuizPage17 extends StatefulWidget {
  QuizPage17({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question17> questions;

  @override
  State<QuizPage17> createState() => _QuizPage17State();
}

class _QuizPage17State extends State<QuizPage17> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen17(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
