...
class ResultScreen20 extends StatefulWidget {
  const ResultScreen20({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen20> createState() => _ResultScreen20State();
}

class _ResultScreen20State extends State<ResultScreen20> {
