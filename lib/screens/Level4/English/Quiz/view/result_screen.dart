...
class ResultScreen16 extends StatefulWidget {
  const ResultScreen16({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  final List<Question16> questions;
  final int score;
  final int totalTime;

  @override
  State<ResultScreen16> createState() => _ResultScreen16State();
}

class _ResultScreen16State extends State<ResultScreen16> {
