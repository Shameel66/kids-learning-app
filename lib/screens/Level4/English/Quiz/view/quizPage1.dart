...
class QuizPage16 extends StatefulWidget {
  QuizPage16({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question16> questions;

  @override
  State<QuizPage16> createState() => _QuizPage16State();
}

class _QuizPage16State extends State<QuizPage16> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen16(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
