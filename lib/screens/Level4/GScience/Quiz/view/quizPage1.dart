...
class QuizPage18 extends StatefulWidget {
  QuizPage18({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question18> questions;

  @override
  State<QuizPage18> createState() => _QuizPage18State();
}

class _QuizPage18State extends State<QuizPage18> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen18(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
