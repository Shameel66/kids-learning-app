...
class ResultScreen13 extends StatefulWidget {
  const ResultScreen13({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen13> createState() => _ResultScreen13State();
}

class _ResultScreen13State extends State<ResultScreen13> {
