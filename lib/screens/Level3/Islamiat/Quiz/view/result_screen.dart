...
class ResultScreen14 extends StatefulWidget {
  const ResultScreen14({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen14> createState() => _ResultScreen14State();
}

class _ResultScreen14State extends State<ResultScreen14> {
