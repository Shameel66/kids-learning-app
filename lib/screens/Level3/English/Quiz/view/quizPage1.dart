...
class QuizPage11 extends StatefulWidget {
  QuizPage11({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question11> questions;

  @override
  State<QuizPage11> createState() => _QuizPage11State();
}

class _QuizPage11State extends State<QuizPage11> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen11(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
