...
import 'package:yasir_fyp/screens/Level1/GKnowledge/Quiz/model/EQuiz1Mode2.dart';
...
class ResultScreen1 extends StatefulWidget {
  const ResultScreen1({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen1> createState() => _ResultScreen1State();
}
