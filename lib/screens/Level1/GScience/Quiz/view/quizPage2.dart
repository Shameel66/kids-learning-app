...
import 'package:yasir_fyp/screens/Level1/GScience/Quiz/view/result_screen.dart';
...
class QuizPage5 extends StatefulWidget {
  QuizPage5({required this.totalTime, required this.questions});
...
class _QuizPage5State extends State<QuizPage5> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen5(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
