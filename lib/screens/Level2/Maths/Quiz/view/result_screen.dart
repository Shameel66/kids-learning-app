...
class ResultScreen10 extends StatefulWidget {
  const ResultScreen10({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen10> createState() => _ResultScreen10State();
}

class _ResultScreen10State extends State<ResultScreen10> {
