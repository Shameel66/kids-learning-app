...
class QuizPage7 extends StatefulWidget {
  QuizPage7({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question7> questions;

  @override
  State<QuizPage7> createState() => _QuizPage7State();
}

class _QuizPage7State extends State<QuizPage7> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen7(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
