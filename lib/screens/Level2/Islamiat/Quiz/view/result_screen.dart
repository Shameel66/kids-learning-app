...
class ResultScreen9 extends StatefulWidget {
  const ResultScreen9({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen9> createState() => _ResultScreen9State();
}

class _ResultScreen9State extends State<ResultScreen9> {
