...
class ResultScreen6 extends StatefulWidget {
  const ResultScreen6({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  final List<Question6> questions;
  final int score;
  final int totalTime;

  @override
  State<ResultScreen6> createState() => _ResultScreen6State();
}

class _ResultScreen6State extends State<ResultScreen6> {
