...
import 'package:yasir_fyp/screens/Level4/Maths/Quiz/view/quizPage2.dart';
import 'package:yasir_fyp/screens/Level5/Maths/Quiz/view/quizPage2.dart';
...
class ResultScreen25 extends StatefulWidget {
  const ResultScreen25({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen25> createState() => _ResultScreen25State();
}

class _ResultScreen25State extends State<ResultScreen25> {
