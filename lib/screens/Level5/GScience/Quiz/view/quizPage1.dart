...
import 'package:yasir_fyp/screens/Level4/GKnowledge/Quiz/view/result_screen.dart';
import 'package:yasir_fyp/screens/Level4/GScience/Quiz/view/result_screen.dart';
import 'package:yasir_fyp/screens/Level5/GScience/Quiz/view/result_screen.dart';
import 'package:yasir_fyp/widgets/gradientBox.dart';
import '../model/EQuiz1Model.dart';


class QuizPage23 extends StatefulWidget {
  QuizPage23({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question23> questions;

  @override
  State<QuizPage23> createState() => _QuizPage23State();
}

class _QuizPage23State extends State<QuizPage23> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen23(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
