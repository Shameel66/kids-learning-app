...
import 'package:yasir_fyp/screens/Level5/GScience/Quiz/view/quizPage1.dart';
...
class ResultScreen23 extends StatefulWidget {
  const ResultScreen23({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen23> createState() => _ResultScreen23State();
}

class _ResultScreen23State extends State<ResultScreen23> {
