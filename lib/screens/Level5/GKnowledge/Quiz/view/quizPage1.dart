...
import 'package:yasir_fyp/screens/Level5/GKnowledge/Quiz/view/result_screen.dart';
import 'package:yasir_fyp/widgets/gradientBox.dart';
import '../model/EQuiz1Model.dart';


class QuizPage22 extends StatefulWidget {
  QuizPage22({required this.totalTime, required this.questions});

  final int totalTime;
  final List<Question22> questions;

  @override
  State<QuizPage22> createState() => _QuizPage22State();
}

class _QuizPage22State extends State<QuizPage22> {
  ...
  void pushResultScreen(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ResultScreen22(questions: widget.questions, score: _score,totalTime: widget.totalTime,),
      ),
    );
  }
}
