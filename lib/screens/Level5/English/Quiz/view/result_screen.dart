...
import 'package:yasir_fyp/screens/Level5/English/Quiz/view/quizPage1.dart';
...
class ResultScreen21 extends StatefulWidget {
  const ResultScreen21({Key? key, required this.questions, required this.score,required this.totalTime})
      : super(key: key);
  ...
  @override
  State<ResultScreen21> createState() => _ResultScreen21State();
}

class _ResultScreen21State extends State<ResultScreen21> {
